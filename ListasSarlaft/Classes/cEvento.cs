...
namespace ListasSarlaft.Classes
{
    public class cEvento : cPropiedades
    {
            ...
            try
            {
                ...
                switch (numeroQuery)
                {
                    ...
                    case "2":
                        ...
                        strQry1 = "SELECT a.CodigoEvento 'Código', LTRIM(RTRIM(ISNULL(em.Descripcion, ''))) Empresa, PAr.NombreArea Area, usu.Usuario Usuario, LTRIM(RTRIM(USU.Nombres)) + ' ' + LTRIM(RTRIM(USU.Apellidos)) NombreUsuarioRegistro, SUBSTRING(CONVERT(VARCHAR,a.FechaEvento, 120), 1, 10) 'Fecha Registro'," +"\n"+
                            " reg.NombreRegion 'Región', pai.NombrePais 'Pais', dep.NombreDepartamento Departamento, ciu.NombreCiudad Ciudad, ofi.NombreOficinaSucursal 'Oficina/Sucursal' , a.DetalleUbicacion 'Detalle Ubicación', a.DescripcionEvento 'Descripción Evento', ser.Descripcion 'Servicio/Producto', "+"\n" +
                           "subs.SubDescripcion 'SubServicio/SubProducto', SUBSTRING(CONVERT(VARCHAR, a.FechaInicio, 120), 1, 10) 'Fecha Inicio', a.HoraInicio 'Hora Inicio', SUBSTRING(CONVERT(VARCHAR, a.FechaFinalizacion, 120), 1, 10) 'Fecha Finalización', a.HoraFinalizacion 'Hora Finalización', " + "\n" +
                           "SUBSTRING(CONVERT(VARCHAR, a.FechaDescubrimiento, 120), 1, 10) 'Fecha Descubrimiento', a.HoraDescubrimiento 'Hora Descubrimiento',can.Descripcion Canal,gen.Descripcion 'Generador del Evento', a.NomGeneradorEvento 'Responsable Evento', a.CuantiaPerdida 'Posible Cuantía de Pérdida'," + "\n" +
                           " cv.NombreCadenaValor 'Cadena Valor', mp.Nombre MacroProceso, pp.Nombre Proceso, sp.Nombre SubProceso, pa.Nombre Actividad, jer1.NombreResponsable 'Responsable Solución', ec.Descripcion 'Clasificación Nivel 1',esc.SubDescripcion 'Clasificación Nivel 2',ecn3.nombre as 'Clasificación Nivel 3', ptp.NombreTipoPerdidaEvento 'Tipo de Pérdida'" + "\n" +
                           ", eln.Descripcion 'Línea Operativa', esln.SubDescripcion 'SubLínea Operativa', a.MasLineas 'Más Líneas Operativas', CASE a.AfectaContinudad WHEN 1 THEN 'Si' WHEN 0 THEN 'No' END 'Afecta Continuidad', ee.Descripcion Estado, a.Observaciones, jer2.NombreResponsable 'Responsable Contabilidad'," + "\n" +
                           " a.CuentaPUC 'Cuenta PUC', a.CuentaOrden 'Valor recuperado por seguros', a.TasaCambio1 'Tasa de Cambio', a.ValorPesos1 'Pérdida inicial', a.ValorRecuperadoTotal 'Valor recuperado otros conceptos', a.TasaCambio2 'Tasa de Cambio 2', a.ValorPesos2 'Pérdida Final', CASE a.Recuperacion WHEN 1 THEN 'Si' WHEN 0 THEN 'No' END 'Recuperación'," + "\n" +
                           " a.ValorRecuperacion 'Fuente de la Recuperación',SUBSTRING(CONVERT(VARCHAR,a.FechaContabilidad, 120), 1, 10) 'Fecha Contabilización'";
                        strQry2 = "FROM Riesgos.Eventos a " + "\n" +
                            ...
                            "LEFT JOIN [Eventos].[ClasificacionN3] as ecn3 on ecn3.id = a.idClasificacionN3";
        ...
        public void modificarEvento(String IdCadenaValor, String IdMacroproceso, String IdProceso, String IdSubProceso, String IdActividad, String ResponsableEvento, String IdClase, 
            String IdSubClase, String IdTipoPerdidaEvento, String AfectaContinudad, String IdEstado, String Observaciones, String IdEvento, String IdLineaProceso, String IdSubLineaProceso, String MasLineas
            ,string idClasificacionN3)
        {
            try
            {
                cDataBase.conectar();
                cDataBase.ejecutarQuery("UPDATE Riesgos.Eventos SET IdCadenaValor='" + IdCadenaValor + "',IdMacroproceso = '" + IdMacroproceso + "',IdProceso = '" + IdProceso + "', IdSubProceso  ='" + IdSubProceso + "',IdActividad  ='" + IdActividad + "',ResponsableEvento='" + ResponsableEvento + "',IdClase ='" + IdClase + "',IdSubClase='" + IdSubClase + "', IdTipoPerdidaEvento='" + IdTipoPerdidaEvento + "',AfectaContinudad='" + AfectaContinudad + "',IdEstado='" + IdEstado + "',Observaciones='" + Observaciones + "',IdLineaProceso=" + IdLineaProceso + ",IdSubLineaProceso=" + IdSubLineaProceso + ",MasLineas='" + MasLineas + "', idClasificacionN3 = "+ idClasificacionN3 + " WHERE (CodigoEvento = '" + IdEvento + "')");
                cDataBase.desconectar();
            }
            catch (Exception ex)
            {
        ...
        public DataTable loadInfoEventosvsUsuario( int IdUsuarioJerarquia)
        {
            ...
            try
            {
                ...
                if (Area != "R")
                {
                    ...
                    condicion += strConsulta = string.Format(" or ([ResponsableEvento] = {0} or a.IdUsuario = {1})", IdUsuarioJerarquia,  Session["IdUsuario"].ToString());
                ...
                strSelect = "SELECT a.IdEvento,a.CodigoEvento,a.IdEmpresa,a.IdRegion,a.IdPais,a.IdDepartamento,a.IdCiudad,a.IdOficinaSucursal," +
                    "a.DetalleUbicacion,a.DescripcionEvento,a.IdServicio,a.IdSubServicio,substring(convert(varchar,a.FechaInicio,120),1,10) as FechaInicio," +
                    "substring(a.HoraInicio,1,2) as HorI,substring(a.HoraInicio,4,2) as MinI,substring(a.HoraInicio,7,3) as amI,substring(convert(varchar,a.FechaFinalizacion,120),1,10) as FechaFinalizacion,substring(a.HoraFinalizacion,1,2) as HorF,substring(a.HoraFinalizacion,4,2) as MinF," +
                    "substring(a.HoraFinalizacion,7,3) as amF,substring(convert(varchar,a.FechaDescubrimiento,120),1,10) as FechaDescubrimiento,substring(a.HoraDescubrimiento,1,2) as HorD,substring(a.HoraDescubrimiento,4,2) as MinD,substring(a.HoraDescubrimiento,7,3) as amD,a.IdCanal,a.IdGeneraEvento," +
                    "a.GeneraEvento, j1.NombreResponsable as GeneradorEvento,a.cuantiaperdida,substring(convert(varchar,a.FechaEvento,120),1,10) as FechaEvento,u.Usuario,a.IdCadenaValor,a.IdMacroproceso,a.IdProceso,a.IdSubProceso,a.IdActividad," +
                    "a.ResponsableEvento,j2.NombreResponsable as ResponsableSolucion,a.IdClase,b.Descripcion as NombreClaseEvento,a.IdSubClase,c.NombreTipoPerdidaEvento,a.AfectaContinudad,case a.IdEstado when 1 then 'Abierto' else 'Cerrado' end as IdEstado,a.Observaciones," +
                    "a.ResponsableContabilidad,j3.NombreResponsable as NombreResContabilidad,a.CuentaPUC,a.CuentaOrden,a.CuentaPerdida,a.Moneda1,a.TasaCambio1,a.ValorPesos1,a.ValorRecuperadoTotal,a.Moneda2,a.TasaCambio2,a.ValorPesos2,a.ValorRecuperadoSeguro,a.ValorPesos3,a.Recuperacion," +
                    "a.ValorRecuperacion,a.IdLineaProceso,a.IdSubLineaProceso,a.MasLineas,a.NomGeneradorEvento, SUBSTRING(CONVERT(VARCHAR,a.FechaContabilidad,120),1,10) AS FechaContab,SUBSTRING(a.HoraContabilidad,1,2) as HoraContab,SUBSTRING(a.HoraContabilidad,4,2) AS MinContab," +
                    "SUBSTRING(a.HoraContabilidad,7,3) AS amContab, u.IdJerarquia, a.idClasificacionN3";
                strFrom = "FROM Riesgos.Eventos a LEFT JOIN Eventos.Clase b on a.IdClase = b.IdClase LEFT JOIN Parametrizacion.TipoPerdidaEvento c on a.IdTipoPerdidaEvento = c.IdTipoPerdidaEvento LEFT JOIN Listas.Usuarios u on a.IdUsuario = u.IdUsuario LEFT JOIN Parametrizacion.DetalleJerarquiaOrg j1 on j1.idHijo = a.GeneraEvento LEFT JOIN Parametrizacion.DetalleJerarquiaOrg j2 on j2.idHijo = a.ResponsableEvento LEFT JOIN Parametrizacion.DetalleJerarquiaOrg j3 on a.ResponsableContabilidad = j3.idHijo Where IdEstado = 1 AND u.IdUsuario = " + Session["IdUsuario"].ToString() + "";
        ...
        public DataTable loadInfoEventosvsUsuarioMod(string codigo, int IdUsuarioJerarquia)
        {
            DataTable dtInformacion = new DataTable();
            string condicion = string.Empty;
            string strConsulta = string.Empty, strSelect = string.Empty, strFrom = string.Empty, strRiesgo = string.Empty;
            ...
            try
            {
                ...
                //23-01-2014
                //dtInformacion = cDataBase.ejecutarConsulta("select a.IdEvento,a.CodigoEvento,a.IdEmpresa,a.IdRegion,a.IdPais,a.IdDepartamento,a.IdCiudad,a.IdOficinaSucursal,a.DetalleUbicacion,a.DescripcionEvento,a.IdServicio,a.IdSubServicio,substring(convert(varchar,a.FechaInicio,120),1,10) as FechaInicio,a.HoraInicio,substring(convert(varchar,a.FechaFinalizacion,120),1,10) as FechaFinalizacion,a.HoraFinalizacion,substring(convert(varchar,a.FechaDescubrimiento,120),1,10) as FechaDescubrimiento,a.HoraDescubrimiento,a.IdCanal,a.IdGeneraEvento,a.GeneraEvento, j1.NombreResponsable as GeneradorEvento,a.cuantiaperdida,substring(convert(varchar,a.FechaEvento,120),1,10) as FechaEvento,u.Usuario,a.IdCadenaValor,a.IdMacroproceso,a.IdProceso,a.IdSubProceso,a.IdActividad,a.ResponsableEvento,j2.NombreResponsable as ResponsableSolucion,a.IdClase,b.Descripcion as NombreClaseEvento,a.IdSubClase,c.NombreTipoPerdidaEvento,a.AfectaContinudad,a.IdEstado,a.Observaciones,a.ResponsableContabilidad,j3.NombreResponsable as NombreResContabilidad,a.CuentaPUC,a.CuentaOrden,a.CuentaPerdida,a.Moneda1,a.TasaCambio1,a.ValorPesos1,a.ValorRecuperadoTotal,a.Moneda2,a.TasaCambio2,a.ValorPesos2,a.ValorRecuperadoSeguro,a.ValorPesos3,a.Recuperacion,a.ValorRecuperacion,a.IdLineaProceso,a.IdSubLineaProceso,a.MasLineas FROM Riesgos.Eventos a left join Eventos.Clase b on a.IdClase = b.IdClase left join Parametrizacion.TipoPerdidaEvento c on a.IdTipoPerdidaEvento = c.IdTipoPerdidaEvento left join Listas.Usuarios u on a.IdUsuario = u.IdUsuario left join Parametrizacion.DetalleJerarquiaOrg j1 on j1.idHijo = a.GeneraEvento left join Parametrizacion.DetalleJerarquiaOrg j2 on j2.idHijo = a.ResponsableEvento left join Parametrizacion.DetalleJerarquiaOrg j3 on a.ResponsableContabilidad = j3.idHijo " + condicion + " ORDER BY a.IdEvento");
                strSelect = "SELECT a.IdEvento,a.CodigoEvento,a.IdEmpresa,a.IdRegion,a.IdPais,a.IdDepartamento,a.IdCiudad,a.IdOficinaSucursal,a.DetalleUbicacion,a.DescripcionEvento,a.IdServicio,a.IdSubServicio,substring(convert(varchar,a.FechaInicio,120),1,10) as FechaInicio,substring(a.HoraInicio,1,2) as HorI,substring(a.HoraInicio,4,2) as MinI,substring(a.HoraInicio,7,3) as amI,substring(convert(varchar,a.FechaFinalizacion,120),1,10) as FechaFinalizacion,substring(a.HoraFinalizacion,1,2) as HorF,substring(a.HoraFinalizacion,4,2) as MinF,substring(a.HoraFinalizacion,7,3) as amF,substring(convert(varchar,a.FechaDescubrimiento,120),1,10) as FechaDescubrimiento,substring(a.HoraDescubrimiento,1,2) as HorD,substring(a.HoraDescubrimiento,4,2) as MinD,substring(a.HoraDescubrimiento,7,3) as amD,a.IdCanal,a.IdGeneraEvento,a.GeneraEvento, j1.NombreResponsable as GeneradorEvento,a.cuantiaperdida,substring(convert(varchar,a.FechaEvento,120),1,10) as FechaEvento,u.Usuario,a.IdCadenaValor,a.IdMacroproceso,a.IdProceso,a.IdSubProceso,a.IdActividad,a.ResponsableEvento,j2.NombreResponsable as ResponsableSolucion,a.IdClase,b.Descripcion as NombreClaseEvento,a.IdSubClase,c.NombreTipoPerdidaEvento,a.AfectaContinudad,case a.IdEstado when 1 then 'Abierto' else 'Cerrado' end as IdEstado,a.Observaciones,a.ResponsableContabilidad,j3.NombreResponsable as NombreResContabilidad,a.CuentaPUC,a.CuentaOrden,a.CuentaPerdida,a.Moneda1,a.TasaCambio1,a.ValorPesos1,a.ValorRecuperadoTotal,a.Moneda2,a.TasaCambio2,a.ValorPesos2,a.ValorRecuperadoSeguro,a.ValorPesos3,a.Recuperacion,a.ValorRecuperacion,a.IdLineaProceso,a.IdSubLineaProceso,a.MasLineas,a.NomGeneradorEvento, SUBSTRING(CONVERT(VARCHAR,a.FechaContabilidad,120),1,10) AS FechaContab,SUBSTRING(a.HoraContabilidad,1,2) as HoraContab,SUBSTRING(a.HoraContabilidad,4,2) AS MinContab,SUBSTRING(a.HoraContabilidad,7,3) AS amContab";
                strFrom = "FROM Riesgos.Eventos a LEFT JOIN Eventos.Clase b on a.IdClase = b.IdClase LEFT JOIN Parametrizacion.TipoPerdidaEvento c on a.IdTipoPerdidaEvento = c.IdTipoPerdidaEvento LEFT JOIN Listas.Usuarios u on a.IdUsuario = u.IdUsuario LEFT JOIN Parametrizacion.DetalleJerarquiaOrg j1 on j1.idHijo = a.GeneraEvento LEFT JOIN Parametrizacion.DetalleJerarquiaOrg j2 on j2.idHijo = a.ResponsableEvento LEFT JOIN Parametrizacion.DetalleJerarquiaOrg j3 on a.ResponsableContabilidad = j3.idHijo Where a.CodigoEvento = '" + codigo + "'";
                //strConsulta = string.Format("{0} {1} {2} ORDER BY a.IdEvento", strSelect, strFrom, condicion);
                strConsulta = string.Format("{0} {1} {2} ORDER BY a.IdEvento", strSelect, strFrom, condicion);
                //dtInformacion = cDataBase.ejecutarConsulta("select a.IdEvento,a.CodigoEvento,a.IdEmpresa,a.IdRegion,a.IdPais,a.IdDepartamento,a.IdCiudad,a.IdOficinaSucursal,a.DetalleUbicacion,a.DescripcionEvento,a.IdServicio,a.IdSubServicio,substring(convert(varchar,a.FechaInicio,120),1,10) as FechaInicio,substring(a.HoraInicio,1,2) as HorI,substring(a.HoraInicio,4,2) as MinI,substring(a.HoraInicio,7,3) as amI,substring(convert(varchar,a.FechaFinalizacion,120),1,10) as FechaFinalizacion,substring(a.HoraFinalizacion,1,2) as HorF,substring(a.HoraFinalizacion,4,2) as MinF,substring(a.HoraFinalizacion,7,3) as amF,substring(convert(varchar,a.FechaDescubrimiento,120),1,10) as FechaDescubrimiento,substring(a.HoraDescubrimiento,1,2) as HorD,substring(a.HoraDescubrimiento,4,2) as MinD,substring(a.HoraDescubrimiento,7,3) as amD,a.IdCanal,a.IdGeneraEvento,a.GeneraEvento, j1.NombreResponsable as GeneradorEvento,a.cuantiaperdida,substring(convert(varchar,a.FechaEvento,120),1,10) as FechaEvento,u.Usuario,a.IdCadenaValor,a.IdMacroproceso,a.IdProceso,a.IdSubProceso,a.IdActividad,a.ResponsableEvento,j2.NombreResponsable as ResponsableSolucion,a.IdClase,b.Descripcion as NombreClaseEvento,a.IdSubClase,c.NombreTipoPerdidaEvento,a.AfectaContinudad,a.IdEstado,a.Observaciones,a.ResponsableContabilidad,j3.NombreResponsable as NombreResContabilidad,a.CuentaPUC,a.CuentaOrden,a.CuentaPerdida,a.Moneda1,a.TasaCambio1,a.ValorPesos1,a.ValorRecuperadoTotal,a.Moneda2,a.TasaCambio2,a.ValorPesos2,a.ValorRecuperadoSeguro,a.ValorPesos3,a.Recuperacion,a.ValorRecuperacion,a.IdLineaProceso,a.IdSubLineaProceso,a.MasLineas,a.NomGeneradorEvento FROM Riesgos.Eventos a left join Eventos.Clase b on a.IdClase = b.IdClase left join Parametrizacion.TipoPerdidaEvento c on a.IdTipoPerdidaEvento = c.IdTipoPerdidaEvento left join Listas.Usuarios u on a.IdUsuario = u.IdUsuario left join Parametrizacion.DetalleJerarquiaOrg j1 on j1.idHijo = a.GeneraEvento left join Parametrizacion.DetalleJerarquiaOrg j2 on j2.idHijo = a.ResponsableEvento left join Parametrizacion.DetalleJerarquiaOrg j3 on a.ResponsableContabilidad = j3.idHijo " + condicion + " ORDER BY a.IdEvento");
                dtInformacion = cDataBase.ejecutarConsulta(strConsulta);
