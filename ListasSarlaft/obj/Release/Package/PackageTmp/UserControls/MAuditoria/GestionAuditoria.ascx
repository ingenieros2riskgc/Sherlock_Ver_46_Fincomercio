                                ...
                                <table bgcolor="#EEEEEE" class="tabla" width="100%">
                                    <tr align="center">
                                        <td>
                                            ...
                                            <asp:HtmlEditorExtender ID="HtmlEditorExtender6" runat="server"
                                                EnableSanitization="false" TargetControlID="txtMetodologia">
                                                <Toolbar> 
                                                                <asp:Undo />
                                                                <asp:Redo />
                                                                <asp:Bold/>
                                    ...
                                    <tr align="center">
                                        <td>
                                            <asp:TextBox ID="txtConclusion" runat="server" Enabled="True" Columns="100" TextMode="MultiLine"
                                                Font-Names="Calibri" Rows="15"></asp:TextBox>
                                            <asp:HtmlEditorExtender ID="HtmlEditorExtender5" runat="server"
                                                EnableSanitization="false" TargetControlID="txtConclusion">
                                                <Toolbar> 
                                                                <asp:Undo />
                                                                <asp:Redo />
                                                                <asp:Bold/>
                                    ...
                                    <tr align="center">
                                        <td>
                                            <asp:TextBox ID="tbxObs" runat="server" Enabled="True" Columns="100" TextMode="MultiLine"
                                                Font-Names="Calibri" Rows="15"></asp:TextBox>
                                            <asp:HtmlEditorExtender ID="HtmlEditorExtender2" runat="server"
                                                EnableSanitization="false" TargetControlID="tbxObs">
                                                <Toolbar> 
                                                                <asp:Undo />
                                                                <asp:Redo />
                                                                <asp:Bold/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:HtmlEditorExtender ID="HtmlEditorExtender1" runat="server"
                                                EnableSanitization="false" TargetControlID="txtHallazgo">
                                                <Toolbar> 
                                                                <asp:Undo />
                                                                <asp:Redo />
                                                                <asp:Bold/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:HtmlEditorExtender ID="HtmlEditorExtender" runat="server"
                                                EnableSanitization="false" TargetControlID="txtComentario">
                                                <Toolbar> 
                                                                <asp:Undo />
                                                                <asp:Redo />
                                                                <asp:Bold/>
                                    ...
                                    <tr align="left">
                                        ...
                                        <td>
                                            ...
                                            <asp:HtmlEditorExtender ID="HtmlEditorExtender3" runat="server"
                                                EnableSanitization="false" TargetControlID="txtRecomendacion">
                                                <Toolbar> 
                                                                <asp:Undo />
                                                                <asp:Redo />
                                                                <asp:Bold/>
                                    ...
                                    <tr align="left">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtDescRiesgo" runat="server" Enabled="True" Columns="100" TextMode="MultiLine"
                                                Font-Names="Calibri" Rows="8"></asp:TextBox>
                                            <asp:HtmlEditorExtender ID="HtmlEditorExtender4" runat="server" EnableSanitization="false"
                                    ...
                                    <tr>
                                        <td align="center">
                                            <table>
                                                ...
                                                EnableSanitization="false" TargetControlID="txtEncabezado">
                                                <Toolbar> 
                                                                <asp:Undo />
                                                                <asp:Redo />
                                                                <asp:Bold/>
                                            ...
                                            <table class="tabla">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:HtmlEditorExtender ID="HtmlEditorExtender70" runat="server" EnableSanitization="false" TargetControlID="txtTarea">
                                                            <Toolbar>
                                                                <asp:Undo />
                                                                <asp:Redo />
                                                                <asp:Bold />
