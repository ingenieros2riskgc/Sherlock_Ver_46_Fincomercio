                                        ...
                                        <td>
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Descripción" DataField="DescripcionEvento" ItemStyle-HorizontalAlign="Center"/>
                                                    <asp:BoundField HeaderText="Clase" DataField="NombreClaseEvento" ItemStyle-HorizontalAlign="Center"/>
                                                    <asp:BoundField HeaderText="Tipo de perdida" DataField="NombreTipoPerdidaEvento" ItemStyle-HorizontalAlign="Center" ControlStyle-Width="300px"/>
                        ...
                        <tr>
                            <td align="center">
                                <asp:TabContainer ID="TabContainerEventos" runat="server" ActiveTabIndex="2" Font-Names="Calibri"
                                    ...
                                    Type="Date" Operator="LessThanEqual" ValidationGroup="Addne"></asp:CompareValidator>
                                    ...
                                    Type="Date" Operator="GreaterThanEqual" ValidationGroup="Addne"></asp:CompareValidator>
                                                    </td>
                                                    <td bgcolor="#BBBBBB" runat="server">
