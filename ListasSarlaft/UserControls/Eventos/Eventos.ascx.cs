...
namespace ListasSarlaft.UserControls.Eventos
{
    public partial class Eventos : System.Web.UI.UserControl
    {
                ...
                try
                {
                    ...
                    if (Convert.ToInt32(Session["IdUsuario"].ToString()) > 0)
                    {
                        cEvento.agregarEvento(ref strCodigoEvento, ddlEmpresa1.SelectedValue.ToString().Trim(), DropDownList1.SelectedValue.ToString().Trim(),
                            ...
                            //, DropDownList16.SelectedValue.ToString().Trim()
                            );
        ...
        protected void ImageButton8_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string codigo = InfoGridEventos.Rows[RowGridEventos]["CodigoEvento"].ToString().Trim();

                    loadGridEventos();
                    loadInfoEventosvsUsuarioMod(codigo);
                    cargardatosevento();
        ...
        protected void ImageButton19_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    loadInfoEventos();
                    Mensaje("Evento actualizado correctamente");
                    cEvento.modificarEvento(DropDownList67.SelectedValue.ToString().Trim(), DropDownList9.SelectedValue.ToString().Trim(), DropDownList10.SelectedValue.ToString().Trim(),
        ...
        private void loadInfoEventosvsUsuarioMod(String codigo)
        {
            DataTable dtInfo = new DataTable();
            int IdUsuarioJerarquia = Convert.ToInt32(Session["IdJerarquia"].ToString());
            dtInfo = cEvento.loadInfoEventosvsUsuarioMod(codigo, IdUsuarioJerarquia);
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Modificar":
                    ...
                    Session["IdJerarquia"] = colsNoVisible[1].ToString();
                    reseteartodo();
                    resetValuesCamposEventos();
                    resetValuesRiesgoEventos();
                    resetValuesJustificacionEvento();
