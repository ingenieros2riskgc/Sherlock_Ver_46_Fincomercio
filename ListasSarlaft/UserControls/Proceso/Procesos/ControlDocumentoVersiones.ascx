...
function ShowButtonSave(){
    document.getElementById('<%=IBinsertGVC.ClientID %>').style.display = "inline";
    
    }
    function ShowButtonUpdate() {
        
        document.getElementById('<%=IBupdateGVC.ClientID %>').style.display = "inline";
    }
function UnShowButton(){
    document.getElementById('<%=IBinsertGVC.ClientID %>').style.display = "none";
    document.getElementById('<%=IBupdateGVC.ClientID %>').style.display = "none";
return true;
}
...
<asp:SqlDataSource ID="sdsTiposDocumentos" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    
    
    SelectCommand="
    SELECT 0 as IdTiposDocumento, '--Seleccione--' as NombreDocumento,'','true' as Estado
    union all
    SELECT [IdTiposDocumento],[NombreDocumento],[DescripcionDocumento],[Estado] FROM [Parametrizacion].[TiposDocumentos]
where Estado = 1"
    >
</asp:SqlDataSource>
            ...
            <div class="TableContains">
                <table class="tabla" align="center" width="80%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlTipoDocumentoFiltro" runat="server" 
                                DataSourceID="sdsTiposDocumentos" DataTextField="NombreDocumento" DataValueField="IdTiposDocumento"
                                Width="300px" CssClass="Apariencia"></asp:DropDownList>
                        </td>
                        <td></td>
                    </tr>
                    <tr>
        ...
        <div id="BodyFormCDV" class="ColumnStyle" runat="server" visible="false">
            <div id="form" class="TableContains">
                <table class="tabla" align="center" width="80%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="rfvTipo" runat="server" ControlToValidate="DDLtipo"
                                ...
                                ValidationGroup="ControlDocument" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
                            <asp:RequiredFieldValidator ID="rfvTipoUp" runat="server" ControlToValidate="DDLtipo"
                                ErrorMessage="Debe ingresar el tipo." ToolTip="Debe ingresar el tipo."
                                ValidationGroup="ControlDocumentUP" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="RowsText">
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:ImageButton ID="btnImgVolver" runat="server" ImageUrl="~/Imagenes/Icons/Button-Previous-icon.png"
                                OnClick="btnImgCancelar_Click" ToolTip="Cancelar" Height="21px" Width="24px" />
                    ...
                    <tr>
                        <td>
                            <div style="overflow-x:auto;width:960px">
                                ...
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                <Columns>
                                    <asp:BoundField DataField="intId" HeaderText="Código" SortExpression="intId" ItemStyle-HorizontalAlign="Center" visible="false"/>
                                    ...
                                    <asp:TemplateField HeaderText="Observaciones" ItemStyle-HorizontalAlign="Left" Visible="false">
                                        <ItemTemplate>
                                            <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 150px">
